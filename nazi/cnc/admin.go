...
func (this *Admin) Handle() {
    ...
    go func() {
        ...
        for {
            ...
            if _, err := this.conn.Write([]byte(fmt.Sprintf("\033]0;Dead Jews: %d | %s \007", BotCount, username))); err != nil {
                this.conn.Close()
                break
            }
            i++
	...
	this.conn.Write([]byte("\033[31;1m          WELCOME TO NAZi NET         \r\n"))
	...
	this.conn.Write([]byte("\033[31;1m                  ▀█▀					\r\n"))
	this.conn.Write([]byte("\033[31;1m							            \r\n"))
	this.conn.Write([]byte("\033[31;1m                 TYPE ?   			\r\n"))
	this.conn.Write([]byte("\033[31;1m              FOR COMMANDS   			\r\n"))
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\x1b[0;31m" + username + "\x1b[0;37m@\x1b[0;31mNazi\x1b[0;37m# \033[0m"))
